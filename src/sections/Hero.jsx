...
const Hero = () => {
  ...
  return (
    <section id="home" className='w-full max-container flex xl:flex-row flex-col justify-center min-h-screen'>
      ...
      max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoeImg} alt="shoe collection" className='w-[610px] h-[500px] z-10 relative object-contain' />
